...
import { listWebAssistantToolDefinitions } from "../../../runtime/tools/webAssistantHostToolDefinitions";

const TOOL_DESCRIPTION_BY_NAME = new Map(
  listWebAssistantToolDefinitions().map((definition) => [
    definition.name,
...
export function getWebAssistantLabels(): ChatMessageListLabels {
  return {
    ...DEFAULT_CHAT_MESSAGE_LIST_LABELS,
    userLabel: "You",
