const SESSION_STORAGE_KEY_PREFIX = "dawnchat.web-ai-assistant.session.v1::";
const TRANSCRIPT_STORAGE_KEY_PREFIX = "dawnchat.web-ai-assistant.transcript.v1::";

export interface WebAssistantIdentity {
...
let cachedIdentity: WebAssistantIdentity | null = null;
...
export function getWebAssistantIdentity(): WebAssistantIdentity {
  if (cachedIdentity) {
...
export function resetWebAssistantIdentityForTests() {
  cachedIdentity = null;
}
