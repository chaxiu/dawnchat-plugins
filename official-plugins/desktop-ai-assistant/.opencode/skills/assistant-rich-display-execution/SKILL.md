...
- If a resume just succeeded and `continuation_hint.pending_wait` exists, do not treat the task as a normal single-step mutation; hand off to `assistant-wait-resume-handoff`.
