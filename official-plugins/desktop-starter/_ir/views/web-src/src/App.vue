...
import HolographicCommandOrbScene from "./scenes/HolographicCommandOrbScene.vue";

type SceneKey = "neural" | "plasma" | "holographic" | "portal";
...
const activeScene = ref<SceneKey>("neural");
