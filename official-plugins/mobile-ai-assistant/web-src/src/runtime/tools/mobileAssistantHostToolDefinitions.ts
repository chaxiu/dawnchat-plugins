...
export const MOBILE_ASSISTANT_LOCAL_TOOL_DEFINITIONS: AgentLoopToolDefinition[] = [
  {
    name: "math.add",
...
export function listMobileAssistantToolDefinitions(): AgentLoopToolDefinition[] {
  ...
  return [
    ...MOBILE_ASSISTANT_LOCAL_TOOL_DEFINITIONS,
    ...DIRECT_ASSISTANT_ORCHESTRATION_TOOL_DEFINITIONS,
    ...DAWNCHAT_UI_ALIAS_TOOL_DEFINITIONS,
    ...runtimeTools,
  ];
