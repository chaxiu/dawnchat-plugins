---
name: tutor-capability-discovery
description: Discover and normalize current tutor UI capabilities via MCP list operation before any invoke call.
...
- Flag missing capabilities for evolution path.

## Mandatory Rules

- Never invoke any tutor UI function before capability list succeeds.
