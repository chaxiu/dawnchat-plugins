...
def source_mappings() -> list[dict[str, str]]:
    return [
        ...
        },
        {
            "id": "agent-skill-01",
            "source_root": "instructware.org",
            "source_rel": "agent/v2/skills/01-page-intent-authoring.md",
            "target": "agent/v2/skills/01-page-intent-authoring.md",
        },
        {
            "id": "agent-skill-02",
            "source_root": "instructware.org",
            "source_rel": "agent/v2/skills/02-intent-annotation.md",
            "target": "agent/v2/skills/02-intent-annotation.md",
        },
        {
            "id": "agent-skill-03",
            "source_root": "instructware.org",
            "source_rel": "agent/v2/skills/03-ir-implementation.md",
            "target": "agent/v2/skills/03-ir-implementation.md",
        },
        {
            "id": "agent-skill-04",
            "source_root": "instructware.org",
            "source_rel": "agent/v2/skills/04-link-alignment.md",
            "target": "agent/v2/skills/04-link-alignment.md",
        },
        {
            "id": "agent-skill-05",
            "source_root": "instructware.org",
            "source_rel": "agent/v2/skills/05-reverse-review.md",
            "target": "agent/v2/skills/05-reverse-review.md",
        },
        {
            "id": "agent-review-template",
            "source_root": "instructware.org",
            "source_rel": "agent/v2/templates/review-report.v1.json",
            "target": "agent/v2/templates/review-report.v1.json",
        },
    ]
